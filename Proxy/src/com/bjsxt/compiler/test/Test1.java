...
public class Test1 {
	public static void main(String[] args) throws Exception{
		...
		URL[] urls1 = new URL[] {new URL("file:/e:/users/proxy/src/com/bjsxt/proxy")};
		URLClassLoader ul = new URLClassLoader(urls);
		Class c = ul.loadClass("com.bjsxt.proxy.TankTimeProxy");
												
		//Class c = ul.loadClass(System.getProperty("user.dir")+"\\com\\bjsxt\\proxy\\TankTimeProxy");
		//Class c = ul.loadClass("com\\bjsxt\\proxy\\TankTimeProxy");
		//Class c = ul.loadClass("TankTimeProxy");
